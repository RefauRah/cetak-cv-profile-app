...
<head>
  <meta charset="UTF-8">
  <title>{{ $profile->nama_profile }} - Id Card</title>
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
  
  <link rel='stylesheet prefetch' href='http://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css'>

      <link rel="stylesheet" href="{{url('/3-id/3-default/css/style.css')}}">
...
<body>
     <div class="flip-container centered">
      ...
      <p>{{ $profile->work }}</p>
         <div class="font-a-icons">
            <div class="icon-group">
               <span class="bold">T: </span><span class="contact">{{$profile->tlp_profile}}</span>
            <div class="icon-group">
                <span class="bold">E: </span><a class="contact" href="mailto:{{ $user->email }}" target="_top">{{ $user->email }}</a>
            </div>
            <!-- <div class="icon-group"> 
      ...
      <a class="icon-box" href="http://codepen.io/Gothburz/" target="_blank"><i class="fa fa-codepen"></i></a>
